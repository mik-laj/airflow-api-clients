...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Pool result = apiInstance.createPool(pool);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PoolApi#createPool");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            void result = apiInstance.deletePool(poolName);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Pool result = apiInstance.updatePool(poolName, pool, updateMask);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PoolApi#updatePool");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
