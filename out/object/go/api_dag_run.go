...
/*
CreateDagRun Trigger a DAG Run
...
@return DagRun
*/
func (a *DAGRunApiService) CreateDagRun(ctx _context.Context, dagId string, dagRunId string, dagRun DagRun) (DagRun, *_nethttp.Response, error) {
	var (
...
// UpdateDagRunOpts Optional parameters for the method 'UpdateDagRun'
type UpdateDagRunOpts struct {
    UpdateMask optional.Interface
}

/*
UpdateDagRun Update a DAG Run
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dagId The DAG ID.
 * @param dagRunId The DAG Run ID.
 * @param dagRun
 * @param optional nil or *UpdateDagRunOpts - Optional Parameters:
...
@return DagRun
*/
func (a *DAGRunApiService) UpdateDagRun(ctx _context.Context, dagId string, dagRunId string, dagRun DagRun, localVarOptionals *UpdateDagRunOpts) (DagRun, *_nethttp.Response, error) {
	var (
