...
@return Variable
*/
func (a *VariableApiService) CreateVariable(ctx _context.Context, variable Variable) (Variable, *_nethttp.Response, error) {
	var (
...
// UpdateVariableOpts Optional parameters for the method 'UpdateVariable'
type UpdateVariableOpts struct {
    UpdateMask optional.Interface
}

/*
UpdateVariable Update a variable by key
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param variableKey The Variable Key.
 * @param variable
...
@return Variable
*/
func (a *VariableApiService) UpdateVariable(ctx _context.Context, variableKey string, variable Variable, localVarOptionals *UpdateVariableOpts) (Variable, *_nethttp.Response, error) {
	var (
