...
# **create_dag_run**
> DAGRun create_dag_run(dag_id, dag_run_id, dag_run)
...
dag_run = openapi_client.DAGRun() # DAGRun | 
    ...
    try:
        # Trigger a DAG Run
        api_response = api_instance.create_dag_run(dag_id, dag_run_id, dag_run)
        pprint(api_response)
...
# **update_dag_run**
> DAGRun update_dag_run(dag_id, dag_run_id, dag_run, update_mask=update_mask)
