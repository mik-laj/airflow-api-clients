...
from app.openapi_server.models.task_extra_links import TaskExtraLinks  # noqa: F401,E501
from app.openapi_server.models.time_delta import TimeDelta  # noqa: F401,E501
from app.openapi_server.models.trigger_rule import TriggerRule  # noqa: F401,E501
from app.openapi_server.models.weight_rule import WeightRule  # noqa: F401,E501
...
class Task(Model):
    ...
    def __init__(self, class_ref: ClassReference=None, task_id: str=None, owner: str=None, start_date: datetime=None, end_date: datetime=None, trigger_rule: TriggerRule=None, extra_links: List[TaskExtraLinks]=None, depends_on_past: bool=None, wait_for_downstream: bool=None, retries: float=None, queue: str=None, pool: str=None, pool_slots: float=None, execution_timeout: TimeDelta=None, retry_delay: TimeDelta=None, retry_exponential_backoff: bool=None, priority_weight: float=None, weight_rule: WeightRule=None, ui_color: str=None, ui_fgcolor: str=None, template_fields: List[str]=None, sub_dag: DAG=None, downstream_task_ids: List[str]=None):  # noqa: E501
    ...
    @property
    def extra_links(self) -> List[TaskExtraLinks]:
    ...
    @extra_links.setter
    def extra_links(self, extra_links: List[TaskExtraLinks]):
