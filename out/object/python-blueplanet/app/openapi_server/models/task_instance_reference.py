...
class TaskInstanceReference(Model):
    ...
    def __init__(self, task_id: str=None, dag_id: str=None, execution_date: str=None, dag_run_id: str=None):  # noqa: E501
        """TaskInstanceReference - a model defined in Swagger
