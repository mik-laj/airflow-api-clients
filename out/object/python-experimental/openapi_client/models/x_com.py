...
try:
    from openapi_client.models import x_com_collection_item
except ImportError:
    x_com_collection_item = sys.modules[
        'openapi_client.models.x_com_collection_item']
...
class XCom(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """x_com.XCom - a model defined in OpenAPI
