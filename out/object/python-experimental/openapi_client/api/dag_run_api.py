...
from openapi_client.models import dag_run
from openapi_client.models import error
from openapi_client.models import dag_run_collection
from openapi_client.models import list_dag_runs_form
    ...
    def __init__(self, api_client=None):
        ...
        def __create_dag_run(
            ...
            **kwargs
            ...
            >>> thread = api.create_dag_run(dag_id, dag_run_id, dag_run_dag_run, async_req=True)
            >>> result = thread.get()

            Args:
                dag_id (str): The DAG ID.
                dag_run_id (str): The DAG Run ID.
                dag_run_dag_run (dag_run.DAGRun):
            ...
            kwargs['dag_run_id'] = \
                dag_run_id
            kwargs['dag_run_dag_run'] = \
                dag_run_dag_run
            return self.call_with_http_info(**kwargs)

        self.create_dag_run = Endpoint(
            settings={
                'response_type': (dag_run.DAGRun,),
                'auth': [],
                'endpoint_path': '/dags/{dag_id}/dagRuns/{dag_run_id}',
                'operation_id': 'create_dag_run',
                'http_method': 'POST',
                'servers': [],
            },
            params_map={
        ...
        def __get_dag_runs(
            ...
            **kwargs
            ...
            Returns:
                dag_run_collection.DAGRunCollection
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.get_dag_runs = Endpoint(
            settings={
                'response_type': (dag_run_collection.DAGRunCollection,),
                'auth': [],
        ...
        def __get_dag_runs_batch(
            self,
            list_dag_runs_form_list_dag_runs_form,
            **kwargs
        ):
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.get_dag_runs_batch(list_dag_runs_form_list_dag_runs_form, async_req=True)
            >>> result = thread.get()

            Args:
                list_dag_runs_form_list_dag_runs_form (list_dag_runs_form.ListDagRunsForm):
            ...
            kwargs['_host_index'] = kwargs.get('_host_index', 0)
            kwargs['list_dag_runs_form_list_dag_runs_form'] = \
                list_dag_runs_form_list_dag_runs_form
            return self.call_with_http_info(**kwargs)
        ...
        self.get_dag_runs_batch = Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'list_dag_runs_form_list_dag_runs_form': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        def __update_dag_run(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.update_dag_run(dag_id, dag_run_id, dag_run_dag_run, async_req=True)
            >>> result = thread.get()
