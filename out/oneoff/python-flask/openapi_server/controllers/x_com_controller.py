...
def update_x_com_entry(dag_id, dag_run_id, task_id, x_com):  # noqa: E501
    ...
    :type task_id: str
    :param x_com: 
    :type x_com: dict | bytes

    :rtype: XCom
    """
    if connexion.request.is_json:
        x_com = XCom.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def update_x_com_value(dag_id, dag_run_id, task_id, xcom_key, x_com, update_mask=None):  # noqa: E501
