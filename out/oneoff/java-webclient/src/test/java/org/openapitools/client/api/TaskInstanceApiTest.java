...
public class TaskInstanceApiTest {
    ...
    public void getExtraLinksTest()  {
        ...
        String taskId = null;
        ExtraLinkCollection response = api.getExtraLinks(dagId, dagRunId, taskId).block();
    ...
    public void getLogsTest()  {
        ...
        String token = null;
        InlineResponse200 response = api.getLogs(dagId, dagRunId, taskId, taskTryNumber, fullContent, token).block();
    ...
    public void getTaskInstanceTest()  {
        ...
        String dagRunId = null;
        String taskId = null;
        TaskInstance response = api.getTaskInstance(dagId, dagRunId, taskId).block();
    ...
    public void getTaskInstancesTest()  {
        ...
        Integer limit = null;
        Integer offset = null;
        TaskInstanceCollection response = api.getTaskInstances(dagId, dagRunId, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte, durationGte, durationLte, state, pool, queue, limit, offset).block();
    ...
    public void getTaskInstancesBatchTest()  {
        ...
        TaskInstanceCollection response = api.getTaskInstancesBatch(listTaskInstanceForm).block();
