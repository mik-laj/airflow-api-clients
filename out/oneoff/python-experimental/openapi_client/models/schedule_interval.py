...
try:
    from openapi_client.models import cron_expression
except ImportError:
    cron_expression = sys.modules[
        'openapi_client.models.cron_expression']
try:
    from openapi_client.models import relative_delta
except ImportError:
    relative_delta = sys.modules[
        'openapi_client.models.relative_delta']
try:
...
class ScheduleInterval(ModelComposed):
    ...
    def discriminator():
        val = {
            ...
            'RelativeDelta': relative_delta.RelativeDelta,
