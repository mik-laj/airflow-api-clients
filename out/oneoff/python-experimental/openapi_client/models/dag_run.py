...
try:
    from openapi_client.models import one_ofobjectstring
except ImportError:
    one_ofobjectstring = sys.modules[
        'openapi_client.models.one_ofobjectstring']
...
class DAGRun(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'conf': (one_ofobjectstring.OneOfobjectstring,),  # noqa: E501
        }
    ...
    def __init__(self, dag_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            conf (one_ofobjectstring.OneOfobjectstring): [optional]  # noqa: E501
        """
