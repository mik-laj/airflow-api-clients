...
def clear_task_instance(dag_id, body):  # noqa: E501
    ...
    if connexion.request.is_json:
        body = ClearTaskInstance.from_dict(connexion.request.get_json())  # noqa: E501
...
def update_dag(dag_id, body):  # noqa: E501
    """Update a DAG
    ...
    """
    if connexion.request.is_json:
        body = DAG.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
