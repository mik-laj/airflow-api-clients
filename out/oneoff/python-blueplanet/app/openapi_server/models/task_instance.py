...
from app.openapi_server.models.task_state import TaskState  # noqa: F401,E501
...
class TaskInstance(Model):
    ...
    def __init__(self, task_id: str=None, dag_id: str=None, execution_date: str=None, start_date: str=None, end_date: str=None, duration: float=None, state: TaskState=None, try_number: int=None, max_tries: int=None, hostname: str=None, unixname: str=None, pool: str=None, pool_slots: int=None, queue: str=None, priority_weight: int=None, operator: str=None, queued_when: str=None, pid: int=None, executor_config: str=None, sla_miss: SLAMiss=None):  # noqa: E501
        """TaskInstance - a model defined in Swagger
