...
class DAGRunApi(object):
    ...
    def create_dag_run(self, dag_id, dag_run_id, dag_run, **kwargs):  # noqa: E501
        """Trigger a DAG Run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_dag_run(dag_id, dag_run_id, dag_run, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_dag_run_with_http_info(dag_id, dag_run_id, dag_run, **kwargs)  # noqa: E501

    def create_dag_run_with_http_info(self, dag_id, dag_run_id, dag_run, **kwargs):  # noqa: E501
        """Trigger a DAG Run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_dag_run_with_http_info(dag_id, dag_run_id, dag_run, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('dag_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dag_id` when calling `create_dag_run`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dag_run_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dag_run_id` when calling `create_dag_run`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dag_run' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dag_run` when calling `create_dag_run`")  # noqa: E501
    ...
    def update_dag_run(self, dag_id, dag_run_id, dag_run, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_dag_run_with_http_info(dag_id, dag_run_id, dag_run, **kwargs)  # noqa: E501

    def update_dag_run_with_http_info(self, dag_id, dag_run_id, dag_run, **kwargs):  # noqa: E501
        """Update a DAG Run  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dag_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dag_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dag_id` when calling `update_dag_run`")  # noqa: E501
        # verify the required parameter 'dag_run_id' is set
        if self.api_client.client_side_validation and ('dag_run_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dag_run_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dag_run_id` when calling `update_dag_run`")  # noqa: E501
        # verify the required parameter 'dag_run' is set
        if self.api_client.client_side_validation and ('dag_run' not in local_var_params or  # noqa: E501
                                                        local_var_params['dag_run'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dag_run` when calling `update_dag_run`")  # noqa: E501
