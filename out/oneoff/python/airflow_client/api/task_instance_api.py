...
class TaskInstanceApi(object):
    ...
    def get_logs(self, dag_id, dag_run_id, task_id, task_try_number, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_logs_with_http_info(dag_id, dag_run_id, task_id, task_try_number, **kwargs)  # noqa: E501

    def get_logs_with_http_info(self, dag_id, dag_run_id, task_id, task_try_number, **kwargs):  # noqa: E501
        """Get logs for a task instance  # noqa: E501

        Get logs for a specific task instance and its try number  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logs_with_http_info(dag_id, dag_run_id, task_id, task_try_number, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('dag_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dag_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dag_id` when calling `get_logs`")  # noqa: E501
        # verify the required parameter 'dag_run_id' is set
        if self.api_client.client_side_validation and ('dag_run_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dag_run_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dag_run_id` when calling `get_logs`")  # noqa: E501
        # verify the required parameter 'task_id' is set
        if self.api_client.client_side_validation and ('task_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['task_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `task_id` when calling `get_logs`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('task_try_number' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `task_try_number` when calling `get_logs`")  # noqa: E501
