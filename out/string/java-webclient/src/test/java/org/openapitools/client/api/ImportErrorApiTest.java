...
public class ImportErrorApiTest {
    ...
    public void deleteImportErrorTest()  {
        ...
        api.deleteImportError(importErrorId).block();
    ...
    public void getImportErrorTest()  {
        Integer importErrorId = null;
        ImportError response = api.getImportError(importErrorId).block();
    ...
    public void getImportErrorsTest()  {
        Integer limit = null;
        Integer offset = null;
        ImportErrorCollection response = api.getImportErrors(limit, offset).block();
