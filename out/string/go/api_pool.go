...
@return Pool
*/
func (a *PoolApiService) CreatePool(ctx _context.Context, pool Pool) (Pool, *_nethttp.Response, error) {
	var (
...
@return Pool
*/
func (a *PoolApiService) UpdatePool(ctx _context.Context, poolName string, pool Pool, localVarOptionals *UpdatePoolOpts) (Pool, *_nethttp.Response, error) {
	var (
