...
> DagRun CreateDagRun(ctx, dagId, dagRunId, dagRun)
...
> DagRun UpdateDagRun(ctx, dagId, dagRunId, dagRun, optional)
...
**dagRunId** | **string**| The DAG Run ID. | 
**dagRun** | [**DagRun**](DagRun.md)|  | 
 **optional** | ***UpdateDagRunOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a UpdateDagRunOpts struct
