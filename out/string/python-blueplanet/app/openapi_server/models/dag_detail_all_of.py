...
class DAGDetailAllOf(Model):
    ...
    def __init__(self, timezone: str=None, catchup: bool=None, orientation: str=None, concurrency: float=None, start_date: datetime=None, dag_run_timeout: TimeDelta=None, doc_md: str=None, default_view: str=None):  # noqa: E501
        """DAGDetailAllOf - a model defined in Swagger
