...
class XComCollectionItem(Model):
    ...
    def __init__(self, key: str=None, timestamp: str=None, execution_date: str=None, task_id: str=None, dag_id: str=None):  # noqa: E501
        """XComCollectionItem - a model defined in Swagger
