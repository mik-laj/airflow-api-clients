...
class DAGRun(Model):
    ...
    def __init__(self, dag_run_id: str=None, dag_id: str=None, execution_date: datetime=None, start_date: datetime=None, end_date: datetime=None, state: DagState=None, external_trigger: bool=True, conf: str=None):  # noqa: E501
