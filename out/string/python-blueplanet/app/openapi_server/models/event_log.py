...
class EventLog(Model):
    ...
    def __init__(self, event_log_id: int=None, when: str=None, dag_id: str=None, task_id: str=None, event: str=None, execution_date: str=None, owner: str=None, extra: str=None):  # noqa: E501
