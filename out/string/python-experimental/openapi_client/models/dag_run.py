...
try:
    from openapi_client.models import dag_state
except ImportError:
    dag_state = sys.modules[
        'openapi_client.models.dag_state']
...
class DAGRun(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'state': (dag_state.DagState,),  # noqa: E501
    ...
    def __init__(self, dag_id, *args, **kwargs):  # noqa: E501
        """dag_run.DAGRun - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            state (dag_state.DagState): [optional]  # noqa: E501
            external_trigger (bool): [optional] if omitted the server will use the default value of True  # noqa: E501
            conf (str): JSON object describing additional configuration parameters. The value of this field can be set only when creating the object. If you try to modify the field of an existing object, the request fails with an BAD_REQUEST error. . [optional]  # noqa: E501
        """
