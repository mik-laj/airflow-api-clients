...
from openapi_client.models import pool
from openapi_client.models import pool_collection
    ...
    def __init__(self, api_client=None):
        ...
        def __create_pool(
            ...
            **kwargs
            ...
            >>> thread = api.create_pool(pool_pool, async_req=True)
            >>> result = thread.get()
        ...
        self.get_pools = Endpoint(
            settings={
                'response_type': (pool_collection.PoolCollection,),
                'auth': [],
                'endpoint_path': '/pools',
        ...
        def __update_pool(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.update_pool(pool_name, pool_pool, async_req=True)
            >>> result = thread.get()
