...
class ConnectionApi(object):
    ...
    def create_connection(self, connection, **kwargs):  # noqa: E501
    ...
    def create_connection_with_http_info(self, connection, **kwargs):  # noqa: E501
        """Create connection entry  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('connection' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `connection` when calling `create_connection`")  # noqa: E501
    ...
    def update_connection(self, connection_id, connection, **kwargs):  # noqa: E501
    ...
    def update_connection_with_http_info(self, connection_id, connection, **kwargs):  # noqa: E501
        """Update a connection entry  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('connection' not in local_var_params or  # noqa: E501
                                                        local_var_params['connection'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `connection` when calling `update_connection`")  # noqa: E501
